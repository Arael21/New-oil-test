...
<header class="header">
   ...
   <a href="#home" class="logo"><span class="lgn"> <style>.lgn {color:rgb(37, 128, 37)}</style>N</span>ewoilcosmetic</a>
...
<section class="about" id="about">
   ...
   <div class="row revers">
      <div class="image">
      <video width="400px" height="450px"
        controls="controls"/>
         
        <source src="images/Noc-Oil.mp4"
            type="video/mp4">>
      </div>
      <div class="content">
         <h3>Guaranteed Glow</h3>
         <p>To achieve a natural glow, it is essential to start with a regular skincare routine. Natural oils are an excellent way to nourish and deeply moisturize the skin.</p>
   ...
   <div class="row">
      ...
      <div class="content">
         <h3>Extrem care for your skin</h3>
         <p> Our oil offer an extrem care for your skin . New oil cosmetics for a perfect skin .</p>
   ...
   <div class="box-container">
     ...
     <div class="info-container">
      <div class="blurry-container">
         <form action="user_details_products.php" method="POST">
          <button class="info-link"> Plus d'infos </button>
         </form>
      </div>
   </div>
